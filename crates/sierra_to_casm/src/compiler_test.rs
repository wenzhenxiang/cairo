...
#[test_case(indoc! {"
                ...
                libfunc dict_new<felt> = dict_new<felt>;
                libfunc dict_write<felt> = dict_write<felt>;
                libfunc dict_read<felt> = dict_read<felt>;
                libfunc store_temp_dict_felt = store_temp<DictFelt>;
                ...
                store_temp_felt([2]) -> ([2]);
                dict_new<felt>([2]) -> ([3]);
                dict_write<felt>([3], [0], [1]) -> ([4]);
                felt_const<10>() -> ([5]);
                store_temp_felt([5]) -> ([5]);
                felt_const<13>() -> ([6]);
                store_temp_felt([6]) -> ([6]);
                dict_write<felt>([4], [5], [6]) -> ([7]);
                felt_const<10>() -> ([8]);
                store_temp_felt([8]) -> ([8]);
                dict_read<felt>([7], [8]) -> ([9], [10]);
                store_temp_dict_felt([9]) -> ([9]);
                store_temp_felt([10]) -> ([10]);
                return ([9], [10]);
                test_program@0() -> (DictFelt, felt);
            "},
