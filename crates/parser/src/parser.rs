...
impl<'a> Parser<'a> {
    ...
    fn expect_module(&mut self, attributes: OptionAttributesGreen) -> ItemModuleGreen {
    ...
    fn expect_struct(&mut self, attributes: OptionAttributesGreen) -> ItemStructGreen {
    ...
    fn expect_enum(&mut self, attributes: OptionAttributesGreen) -> ItemEnumGreen {
    ...
    fn expect_extern_item(&mut self, attributes: OptionAttributesGreen) -> ItemGreen {
    ...
    fn expect_use(&mut self, attributes: OptionAttributesGreen) -> ItemUseGreen {
    ...
    fn expect_free_function(&mut self, attributes: OptionAttributesGreen) -> ItemFreeFunctionGreen {
        let function_kw = self.take::<TerminalFunction>();
        let name = self.parse_token::<TerminalIdentifier>();
        let generic_params = self.parse_optional_generic_params();
        let signature = self.expect_function_signature();
    ...
    fn expect_trait(&mut self, attributes: OptionAttributesGreen) -> ItemTraitGreen {
    ...
    fn expect_impl(&mut self, attributes: OptionAttributesGreen) -> ItemImplGreen {
